...
export function BillingWorkspace() {
  ...
  return (
    <div className="space-y-4">
      ...
      <PosInvoicePanel onOpenHistory={() => setHistoryOpen(true)} />
          ...
          <aside className="flex h-full w-full max-w-[980px] flex-col border-l border-border bg-white shadow-2xl">
            <div className="flex items-center justify-between border-b border-border px-5 py-4">
              <div>
                ...
                <div className="text-xs text-slate-500">Search bills, view details, print PDFs, and cancel invoices.</div>
              </div>
